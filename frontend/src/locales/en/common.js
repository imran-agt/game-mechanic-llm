const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description: "Game Mechanic can work with custom fine tuned LLM models.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to Game Mechanic!",
      description: "Help us make Game Mechanic better. Optional.",

      email: "What's your email?",
      useCase: "What will you use Game Mechanic for?",
      useCaseWork: "For programming",
      useCasePersonal: "For documents",
      useCaseOther: "For learning",
      comment: "Which AGT department will be using this service?",
      commentPlaceholder: "Research, GameDev, Lab, QA, Sales",
      skip: "Skip",
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with Game Mechanic.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    ...
    part4:
      'All conversations are organized in "Workspaces". Workspaces are collection of files and texts which are transformed into vector format that LLM\'s can understand and use in conversation.\n\nYou can add and remove files to the conversation.',
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming an Game Mechanic expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of Game Mechanic",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for Game Mechanic.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your Game Mechanic instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for Game Mechanic.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render Game Mechanic's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "Game Mechanic Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this Game Mechanic instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else Game Mechanic will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Game Mechanic when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Game Mechanic can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Game Mechanic instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your Game Mechanic instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Game Mechanic handle your data.",
    llm: "LLM Selection",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this Game Mechanic instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in Game Mechanic we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from Game Mechanic by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in Game Mechanic we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
  ...
  chat_window: {
    welcome: "Welcome to your Game Mechanic workspace.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the Game Mechanic Community Hub before publishing items.",
